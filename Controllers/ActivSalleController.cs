...
{
    public class ActivSalleController : Controller
    {
        private GESRESEntities db = new GESRESEntities();
        // GET: ActivSalle
        public ActionResult ActivSalle(int? id)
        {
        ...
        public ActionResult ActivSalle(int IdSalle,int IdGes,int IdUser,string NomSalle,int CapaciteSalle,decimal PrixSalle,string DescripSalle,string AdrSalle,string ImgSalle1, string ImgSalle2)
        {
